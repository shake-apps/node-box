...
Box.prototype.refreshAccessToken = function (client_id, client_secret, callback) {
  ...
  request
    ...
    .end(function (res) {
      ...
      that.updateAccessToken(res.body.access_token);
...
Folders.prototype.upsert = function (name, parent, callback) {
  ...
  request
    ...
    .end(function (res) {
      if (res.status == 409) {
        conflict = res.body.context_info.conflicts.filter( function(conflict) { return ((conflict.type == 'folder') && (conflict.name == name)) })[0];
